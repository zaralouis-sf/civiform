...
# --- !Ups
alter table accounts add column global_admin boolean constraint ck_account_admin CHECK(admin_of is null or array_length(admin_of, 1) = 0 or global_admin = true);
